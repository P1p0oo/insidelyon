...
function gs_pin_help_menu_cb() {
	?>

    <div class="gsp-wrap">
        
    	<div class="gs_team_wrap gs_team_help" style="width: 845px; float: left; margin-top: 20px; text-align: center;">
	        <h1>GS Pinterest Portfolio by GS Plugins</h1>
			<div class="help-link">
    			<a class="gstm-hlp-btn gstm-btn-1" href="https://www.gsplugins.com/product/wordpress-pinterest-portfolio-plugin" target="_blank">Plugin Home</a>
    			<a class="gstm-hlp-btn gstm-btn-2" href="http://pinterest.gsplugins.com" target="_blank">Live Demo</a>
    			<a class="gstm-hlp-btn gstm-btn-3" href="http://pinterest.gsplugins.com/documentation/" target="_blank">Documentation</a>
    			<a class="gstm-hlp-btn gstm-btn-4" href="http://pinterest.gsplugins.com/documentation/#GS_Pinterest_Portfolio8217s_shortcode_usage" target="_blank">Shortcode Usage</a>
