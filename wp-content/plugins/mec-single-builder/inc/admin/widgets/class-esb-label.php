...
class ESB_Label extends \Elementor\Widget_Base
{
	...
	public function get_title()
	{
		...
		return __('Single Event Labels', 'mec-single-builder');
	}
	...
	protected function register_controls()
	{
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' 	=> [
					'{{WRAPPER}} .mec-single-event-label i:before' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function render()
	{
		...
		echo \MEC\SingleBuilder\SingleBuilder::getInstance()->output( 'event-labels' );
	}
}
