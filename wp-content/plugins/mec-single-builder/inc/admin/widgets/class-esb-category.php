...
class ESB_Category extends \Elementor\Widget_Base
{
	...
	public function get_title()
	{
		...
		return __('Single Event Category', 'mec-single-builder');
	}
	...
	protected function register_controls()
	{
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' 	=> [
					'{{WRAPPER}} .mec-single-event-category i:before' => 'font-size: {{SIZE}}{{UNIT}};',
				],
			]
		);
	...
	protected function render()
	{
		...
		echo \MEC\SingleBuilder\SingleBuilder::getInstance()->output( 'event-category' );
	}
}
